...
We will target the fully leptonic decay channel. We explicitly identify "_Tight_" leptons to suppress backgrounds from non-prompt sources (like QCD). These definitions are handled in `hww_tools/Physics_selection.py`.
